...
namespace YooX {
	static public class VisualElementExtensions {
		/// <summary>
		...
		static public VisualElement CreateChild(this VisualElement parent, params string[] classes) {
		...
		static public T CreateChild<T>(this VisualElement parent, params string[] classes)
		...
		static public T AddTo<T>(this T child, VisualElement parent) where T : VisualElement {
			parent.Add(child);
		...
		/// </remarks>
		static public void RemoveFrom<T>(this T child, VisualElement parent)
		...
		static public T AddClass<T>(this T visualElement, params string[] classes) where T : VisualElement {
		...
		/// </remarks>
		static public void RemoveClass<T>(this T visualElement, params string[] classes) where T : VisualElement {
			foreach (string cls in classes) {
				if (!string.IsNullOrEmpty(cls)) {
		...
		static public T WithManipulator<T>(this T visualElement, IManipulator manipulator) where T : VisualElement {
		...
		static public void SetImageFromSprite(this VisualElement imageContainer, Sprite sprite) {
