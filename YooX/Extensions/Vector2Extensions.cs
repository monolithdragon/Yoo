...
namespace YooX {
	static public class Vector2Extensions {
		...
		/// </summary>
		static public Vector2 Add(this Vector2 vector2, float x = 0, float y = 0) => new(vector2.x + x, vector2.y + y);

		/// <summary>
		/// Sets any x y values of a Vector2
		/// </summary>
		static public Vector2 With(this Vector2 vector2, float? x = null, float? y = null) => new(x ?? vector2.x, y ?? vector2.y);
		...
		static public bool InRangeOf(this Vector2 current, Vector2 target, float range) => (current - target).sqrMagnitude <= range * range;
		...
		static public Vector2 RandomPointInAnnulus(this Vector2 origin, float minRadius, float maxRadius) {
