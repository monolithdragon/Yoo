...
namespace YooX {
	static public class TransformExtensions {
		...
		static public bool InRangeOf(this Transform source, Transform target, float maxDistance, float maxAngle = 360f) {
		...
		static public IEnumerable<Transform> Children(this Transform parent) {
		...
		static public void DestroyChildren(this Transform parent) => parent.ForEveryChild(child => Object.Destroy(child.gameObject));
		...
		static public void DestroyChildrenImmediate(this Transform parent) => parent.ForEveryChild(child => Object.DestroyImmediate(child.gameObject));
		...
		static public void EnableChildren(this Transform parent) => parent.ForEveryChild(child => child.gameObject.SetActive(true));
		...
		static public void DisableChildren(this Transform parent) => parent.ForEveryChild(child => child.gameObject.SetActive(false));
		...
		/// </remarks>
		static public void ForEveryChild(this Transform parent, Action<Transform> action) {
