...
namespace YooX {
	static public class Vector3Extensions {
		...
		/// </summary>
		static public Vector3 With(this Vector3 vector, float? x = null, float? y = null, float? z = null) => new(x ?? vector.x, y ?? vector.y, z ?? vector.z);

		/// <summary>
		/// Adds to any x y z values of a Vector3
		/// </summary>
		static public Vector3 Add(this Vector3 vector, float x = 0, float y = 0, float z = 0) => new(vector.x + x, vector.y + y, vector.z + z);
		...
		static public bool InRangeOf(this Vector3 current, Vector3 target, float range) => (current - target).sqrMagnitude <= range * range;
		...
		static public Vector3 ToVector3(this Vector2 v2) => new(v2.x, 0, v2.y);
		...
		static public Vector3 RandomPointInAnnulus(this Vector3 origin, float minRadius, float maxRadius) {
		...
		static public Vector3 RandomOffset(this Vector3 vector, float range) =>
			vector + new Vector3(
